...
uint256 hashGenesisBlock("0x55a9b3b171a6dfc95d59e07fa23736f44cd745f896e86491982ad6d043c58ba6"); // hitcoin primary genesis
...
static const int64 nTargetSpacing = 60 * 60; // Guncoin: 60 minutes
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanNEW = 60*60 ; // digishield
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "1May launch of hitcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
